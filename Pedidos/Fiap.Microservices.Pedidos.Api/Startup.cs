...
namespace Fiap.Microservices.Pedidos.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = Configuration.GetConnectionString("PedidosDbContextConnection");
            services.AddDbContext<PedidosDbContext>(options => options.UseSqlServer(connection));
